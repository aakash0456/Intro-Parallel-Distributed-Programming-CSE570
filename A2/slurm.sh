...
# IF SET TO 1 SPARK MASTER (DRIVER) RUNS ON A SEPARATE NODE
exclude_master=0

# LOAD SPARK, YOU CAN ADD EXTRA MODULES HERE IF NEEDED
module load spark/2.4.0-py37

# SET YOUR COMMAND AND ARGUMENTS
PROG="A2.py"
ARGS="/panasas/scratch/grp-jzola/intropdp/T0.txt /panasas/scratch/grp-cse570f21/as475/output"
...
# -driver-memory
# -ps-files
SPARK_ARGS="--num-executors 8 --executor-cores 10 --executor-memory 24G"
